<html>
<head>
<title>Оконный калкулятор</title>
</head>
...
<form name=SForm action="1.php">
  &nbsp;<font color="#FF0000">&nbsp;&nbsp;<span lang="ru"><b>Оконный калькулятор </b></span></font><b><font color="#FF0000">:</font></b><br>
<br>
...
<option value="2">2 - Орех</option>
<option value="3">3 - Бук</option>
<option value="4">4 - Лиственница срощенная</option>
<option value="5">5 - Лиственница</option>
<option value="6">6 - Граб</option>
...
<center>
<p> 
 <input type="button" value="Заказать" onClick="zakaz()" name="ZakazButton">
                    </p>
                  </center>
                </td>
              </tr>
